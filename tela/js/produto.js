...
function trocar_imagens_por_cor(cor){
    try{
        ...
        var mapa = {
            'Brasil':   ['assets/img1.webp','assets/br1.webp','assets/br2.webp'],
            'Rosa':     ['assets/img2.webp','assets/rosa1.webp','assets/rosa2.webp'],
            'Argentina':['assets/img3.png','assets/arg1.webp','assets/arg2.webp'],
            'Japão':    ['assets/img4.webp','assets/jap1.webp','assets/jap2.webp'],
            'Japao':    ['assets/img4.webp','assets/jap1.webp','assets/jap2.webp'],
            'Itália':   ['assets/img5.webp','assets/ita1.webp','assets/ita2.webp'],
            'Italia':   ['assets/img5.webp','assets/ita1.webp','assets/ita2.webp']
        };
        var imgs = mapa[cor];
...
function escolher_variação(self){
    ...
    try{
        if(String(titulo).toLowerCase().indexOf('cor') !== -1){
